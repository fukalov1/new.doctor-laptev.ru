...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
                ...
                <h4>Вход на сайт Доктора Лаптева позволит Вам оставлять отзывы, регистрировать анкеты, просматривать закрытую часть сайта и использовать онлайн-сервисы и консультации.</h4>
